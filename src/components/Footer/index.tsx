        ...
        <div className="footer-container">
          ...
          <div className="footer-content flex-item">
            <div className="media flex-item">
              <a href="https://patrickbateman.live/">
              ...
              <a href="https://twitter.com/patrik_erc20?s=21">
                <TwitterIcon />
              </a>
              <a href="https://t.me/patrikportal">
                <TelegramIcon />
              </a>
            ...
            <div className="footer-second-content flex-item">
              ...
              <div className="list-navigation">
                ...
                <div>
                  <p className="para">
                    ©                      <span style={{ color: '#e7bd33' }} >
                    PATRIK BATEMAN </span> 2023
                    {/* <span>
